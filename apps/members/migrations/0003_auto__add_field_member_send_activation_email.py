...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Member.send_activation_email'
        db.add_column(u'members_member', 'send_activation_email',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Member.send_activation_email'
        db.delete_column(u'members_member', 'send_activation_email')
    ...
    models = {
        ...
        u'members.member': {
            'Meta': {'ordering': "['birthday', 'name']", 'object_name': 'Member'},
            ...
            'send_activation_email': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),

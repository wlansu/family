...
class RegisterForm(forms.ModelForm):
    ...
    family_name = forms.CharField(label=_("Family name"), widget=forms.TextInput(attrs={'placeholder': _('Your last name')}))
...
class MailMembersForm(forms.Form):
    ...
    text = forms.CharField(label=_("Message"), required=True, widget=forms.Textarea)
